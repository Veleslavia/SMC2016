...
if __name__ == '__main__':
    ...
    files = [(filename, class_name) for filename, class_name in files_with_classname(datadir, FILE_EXT)]
    for filename, class_name in files:
        print filename
        statsPool = extract_for_one(filename)
        feature_set = feature_set.append(convert_pool_to_dataframe(statsPool, class_name, filename))
